...
- Phase 4의 로컬 Pretendard asset과 license 처리가 완료되었거나 미완료 사유가 기록됨
...
3. 로컬 font license, 관리 화면 문구, 모바일 overflow 등 잔여 항목을 완료 또는 보류 사유로 기록한다.
...
5. `https://member.nangok.app/`에서 `index.html`, JS, CSS, local font가 모두 200으로 응답하는지 확인한다.
